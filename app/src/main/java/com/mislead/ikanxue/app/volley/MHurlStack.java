...
public class MHurlStack implements HttpStack {
  ...
  private static String TAG = "MHurlStack";

  private static final String HEADER_CONTENT_TYPE = "Content-Type";
  private final MHurlStack.UrlRewriter mUrlRewriter;
  private final SSLSocketFactory mSslSocketFactory;

  public MHurlStack() {
    this((MHurlStack.UrlRewriter) null);
  }

  public MHurlStack(MHurlStack.UrlRewriter urlRewriter) {
    this(urlRewriter, (SSLSocketFactory) null);
  }

  public MHurlStack(MHurlStack.UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory) {
    ...
    if (responseCode1 == -1) {
      ...
      while (var12.hasNext()) {
        ...
        if (header.getKey() != null) {
          BasicHeader h =
              new BasicHeader((String) header.getKey(), (String) ((List) header.getValue()).get(0));
